...
def import_oasis_formatter():
    ...
    try:
        ...
        # Le module se trouve dans le répertoire 'scripts/langchain_formatter' au niveau racine du projet
        script_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))),
                                  "scripts", "langchain_formatter", "format_user_profile_oasis_style.py")
        ...
        # Ajouter le répertoire scripts/langchain_formatter au Python path
