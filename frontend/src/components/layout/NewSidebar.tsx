        ...
        {navItems.map((item, index) => (
          <Link href={item.path} key={index} className={styles.navItem}>
            <div className={styles.iconWrapper}>
              ...
              {item.icon === 'Swipe' && (
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                  <path d="M188.13,34.63a12,12,0,0,0-12-6.15L144,35.05V24a12,12,0,0,0-24,0V35.79a12,12,0,0,0,9.38,11.72l47.61,9.52L151.06,81A12,12,0,0,0,152,102.94l25.94-25.94L202.17,79A12,12,0,0,0,224,66l-24.73-24.73a12,12,0,0,0-11.14-6.64ZM96,92a28,28,0,1,0,28,28A28,28,0,0,0,96,92Zm0,32a4,4,0,1,1,4-4A4,4,0,0,1,96,124Zm148,12a12,12,0,0,0-12,12v12H64V148a12,12,0,0,0-24,0v20a20,20,0,0,0,20,20H196a20,20,0,0,0,20-20V148A12,12,0,0,0,244,136Z"></path>
                </svg>
              )}
            </div>
